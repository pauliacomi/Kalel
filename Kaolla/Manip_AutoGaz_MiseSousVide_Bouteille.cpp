...
{
	if(AfxMessageBox("Voulez-vous mettre sous vide jusqu'à la bouteille ?\t\n", MB_YESNO | MB_ICONQUESTION)==IDNO)
	{
		ToutFermer();
		return;
	}
	...
	if(MessageBoxConfirmation("Fermer la bouteille !\tPuis appuyer sur OK\n", MB_OKCANCEL | MB_ICONQUESTION)==IDCANCEL)
	{
		ToutFermer();
		FermerInstruments();
		return;
	...
	AfxMessageBox("Mise sous vide jusqu'à la bouteille terminée\t\n", MB_OK);
