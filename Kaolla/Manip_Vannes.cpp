...
{
	m_KaollaView->MarquerTemoin(num_vanne,"Ouverte");
}

void CManip::SignalerFermetureVanne(int num_vanne)
{
	m_KaollaView->MarquerTemoin(num_vanne,"Fermée");
}
...
{
	m_KaollaView->MarquerEV1("Activée");
}
void CManip::SignalerDesactivationEV1()
{
	m_KaollaView->MarquerEV1("Désactivée");
}
void CManip::SignalerActivationEV2()
{
	m_KaollaView->MarquerEV2("Activée");
}
void CManip::SignalerDesactivationEV2()
{
	m_KaollaView->MarquerEV2("Désactivée");
}
void CManip::SignalerActivationPompe()
{
	m_KaollaView->MarquerPompe("Activée");
}
void CManip::SignalerDesactivationPompe()
{
	m_KaollaView->MarquerPompe("Désactivée");
}
