	...
	*/
	...
	while(root)
	{
		...
		*/
		...
		char * bidon3 = strdup(root->FirstChildElement(type.c_str())->GetText());
		char * bidon4 = strdup(valeur.c_str());

		string temp_nom(strdup(root->FirstChildElement(type.c_str())->GetText()));
