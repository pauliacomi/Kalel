...
{
	PointArretFonction();
	etape_en_cours = MOYENNES_DOSES;
	
	DonneesAutoGrapheEtape();

	AffichageMessages(_T("Début des moyennes doses\r\n"));
	Fermeture_Vanne(5);
	dose=0;
	...
	AffichageEtape(_T("Fin des moyennes doses\r\n"));
	AffichageMessages(_T("Fin des moyennes doses\r\n"));
