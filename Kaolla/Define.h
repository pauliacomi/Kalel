...
#include "Define_Etapes.h"
#include "Define_Type_Experience.h"
#include "Define_Instrument.h"

#define griser FALSE
#define degriser TRUE

#define temps_entre_mesure 10 //secondes
...
/*
#define ArretEtapeTemperature if(demande_arret==ARRET_ETAPE){ demande_arret=INACTIF; return 0;}
#define ArretManipTemperature if(demande_arret==ARRET_IMMEDIAT) return 0;
#define ArretSousVideTemperature if(demande_arret==ARRET_SOUSVIDE) return 0;
*/
