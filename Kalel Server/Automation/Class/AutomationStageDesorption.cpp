...
void Automation::SubstepsDesorption()
{
	...
	// Removal of gas
	if (storage.experimentStatus.substepStatus == SUBSTEP_STATUS_REMOVAL &&
		storage.experimentStatus.isWaiting == false)
	{
	...
	if (storage.experimentStatus.substepStatus == SUBSTEP_STATUS_REMOVAL + 1 &&
		storage.experimentStatus.isWaiting == false)
	{
	...
	if (storage.experimentStatus.substepStatus == SUBSTEP_STATUS_REMOVAL + 2 &&
		storage.experimentStatus.isWaiting == false)
	{
	...
	if (storage.experimentStatus.substepStatus == SUBSTEP_STATUS_REMOVAL + 3 &&
		storage.experimentStatus.isWaiting == false)
	{
	...
	if (storage.experimentStatus.substepStatus == SUBSTEP_STATUS_ABORT + 5 &&
		storage.experimentStatus.isWaiting == false)
	{
	...
	if (storage.experimentStatus.substepStatus == SUBSTEP_STATUS_DESORPTION &&
		storage.experimentStatus.isWaiting == false)
	{
